            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal" style = "height: 35px; vertical-align: middle"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>	
