 ...
 * @author ASUS
 */
@WebServlet(name="DeleteAccountControl", urlPatterns={"/deleteA"})
...
//     DAO dao = new DAO();
//     if (dao.geCartByID(id) != null) {
//            Cart cart = dao.geCartByID(id);
//            dao.deleteProductCartByCartId(cart.getCartId());
//            dao.deletePurchaseById(cart.getCartId());
